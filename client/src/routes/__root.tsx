    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            disabled={retrying || retryUsed}
            onClick={() => {
              if (retrying || retryUsed) return;
              setRetrying(true);
              setRetryUsed(true);
          ...
          >
            {retrying ? "Retrying…" : retryUsed ? "Retry attempted" : "Try again"}
          </button>
          <a
            href="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PeoplePay360 — Employee lifecycle & payroll" },
      {
        name: "description",
        content:
          "PeoplePay360 is an enterprise workspace for employee lifecycle, leave, payroll and IT asset management.",
      },
      { name: "author", content: "PeoplePay360" },
