...
const NAV: { to: string; label: string; icon: typeof Users; roles: Role[]; group: string }[] = [
  ...
  { to: "/app/onboarding", label: "Onboarding", icon: UserPlus, group: "People", roles: ["hr_manager", "hr_user", "admin"] },
  { to: "/app/offboarding", label: "Offboarding", icon: UserMinus, group: "People", roles: ["hr_manager", "hr_user", "admin"] },
  { to: "/app/contracts", label: "Contracts", icon: FileSignature, group: "People", roles: ["hr_manager", "hr_user", "payroll_manager", "admin"] },
  ...
  { to: "/app/leave", label: "Time Off", icon: CalendarDays, group: "Time & Leave", roles: ["employee", "hr_manager", "hr_user", "admin"] },

  // Compensation & Finance
  { to: "/app/payroll", label: "Payroll", icon: BadgeIndianRupee, group: "Compensation", roles: ["hr_manager", "hr_user", "payroll_user", "payroll_manager", "admin"] },
  { to: "/app/payslips", label: "Payslips", icon: Receipt, group: "Compensation", roles: ["employee", "hr_manager", "hr_user", "payroll_user", "payroll_manager", "it_asset_manager", "admin"] },
  { to: "/app/reimbursement", label: "Reimbursement", icon: ReceiptText, group: "Compensation", roles: ["employee", "hr_manager", "hr_user", "payroll_manager", "admin"] },
  { to: "/app/allowance", label: "Allowance", icon: HandCoins, group: "Compensation", roles: ["employee", "hr_manager", "hr_user", "payroll_manager", "admin"] },

  // Operations & IT
  { to: "/app/assets", label: "AssetFlow", icon: Laptop, group: "Operations", roles: ["employee", "it_asset_manager", "hr_manager", "hr_user", "admin"] },
  ...
  // Insights & Governance
  { to: "/app/reports", label: "Reports", icon: FileBarChart2, group: "Insights", roles: ["hr_manager", "hr_user", "payroll_manager", "admin"] },
